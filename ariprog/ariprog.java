...
{  	//search 
  ...
  public static void main (String [] args) throws IOException
  {
	...
	//squares array
		...
		boolean any = false; //test if there are any bps.  
		//out.println("\nSorted Array");		
		//for(int a: bisquare)
		...
		//System.out.println(ap.binarySearch(bisquare, 10, 0)); 
		int MAX = (bisquare[size-1]/(N-1));
		//System.out.println(MAX);
		for(int b = 1, max, i, a; b <= MAX; b++){
		...
		BufferedReader check = new BufferedReader(new FileReader("ariprog.out"));
